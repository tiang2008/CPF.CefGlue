...
public sealed unsafe partial class CefPostDataElement
{
    ...
    /// </summary>
    public bool IsReadOnly => cef_post_data_element_t.is_read_only(_self) != 0;

    /// <summary>
    ///     Return the type of this post data element.
    /// </summary>
    public CefPostDataElementType ElementType => cef_post_data_element_t.get_type(_self);

    /// <summary>
    ///     Return the number of bytes.
    /// </summary>
    public long BytesCount => (long) cef_post_data_element_t.get_bytes_count(_self);
