...
public sealed unsafe partial class CefPrintSettings
{
    ...
    /// </summary>
    public bool IsValid => cef_print_settings_t.is_valid(_self) != 0;

    /// <summary>
    ///     Returns true if the values of this object are read-only. Some APIs may
    ///     expose read-only objects.
    /// </summary>
    public bool IsReadOnly => cef_print_settings_t.is_read_only(_self) != 0;
    ...
    /// </summary>
    public bool IsSelectionOnly => cef_print_settings_t.is_selection_only(_self) != 0;

    /// <summary>
    ///     Returns true if pages will be collated.
    /// </summary>
    public bool WillCollate => cef_print_settings_t.will_collate(_self) != 0;
    ...
    /// </summary>
    public void SetPrinterPrintableArea(CefSize physicalSizeDeviceUnits, CefRectangle printableAreaDeviceUnits,
        bool landscapeNeedsFlip)
    {
