...
public sealed unsafe partial class CefValue
{
    ...
    ///     invalid.
    /// </summary>
    public bool IsValid => cef_value_t.is_valid(_self) != 0;

    /// <summary>
    ///     Returns true if the underlying data is owned by another object.
    /// </summary>
    public bool IsOwned => cef_value_t.is_owned(_self) != 0;

    /// <summary>
    ///     Returns true if the underlying data is read-only. Some APIs may expose
    ///     read-only objects.
    /// </summary>
    public bool IsReadOnly => cef_value_t.is_read_only(_self) != 0;
    ...
    {
        return FromNative(cef_value_t.create());
    }
