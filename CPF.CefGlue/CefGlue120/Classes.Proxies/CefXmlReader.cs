...
public sealed unsafe partial class CefXmlReader
{
    ...
    /// </summary>
    public bool HasError => cef_xml_reader_t.has_error(_self) != 0;
    ...
    /// </summary>
    public CefXmlNodeType NodeType => cef_xml_reader_t.get_type(_self);

    /// <summary>
    ///     Returns the node depth. Depth starts at 0 for the root node.
    /// </summary>
    public int Depth => cef_xml_reader_t.get_depth(_self);
    ...
    /// </summary>
    public bool IsEmptyElement => cef_xml_reader_t.is_empty_element(_self) != 0;

    /// <summary>
    ///     Returns true if the node has a text value.
    /// </summary>
    public bool HasValue => cef_xml_reader_t.has_value(_self) != 0;
    ...
    /// </summary>
    public bool HasAttributes => cef_xml_reader_t.has_attributes(_self) != 0;

    /// <summary>
    ///     Returns the number of attributes.
    /// </summary>
    public int AttributeCount => (int) cef_xml_reader_t.get_attribute_count(_self);

    /// <summary>
    ///     Returns the line number for the current node.
    /// </summary>
    public int LineNumber => cef_xml_reader_t.get_line_number(_self);
