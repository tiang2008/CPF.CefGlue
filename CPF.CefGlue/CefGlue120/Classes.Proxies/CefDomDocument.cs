...
public sealed unsafe partial class CefDomDocument
{
    ...
    /// </summary>
    public CefDomDocumentType DocumentType => cef_domdocument_t.get_type(_self);

    /// <summary>
    ///     Returns the root document node.
    /// </summary>
    public CefDomNode Root =>
        CefDomNode.FromNative(
    ...
    /// </summary>
    public CefDomNode? FocusedNode => CefDomNode.FromNativeOrNull(cef_domdocument_t.get_focused_node(_self));

    /// <summary>
    ///     Returns true if a portion of the document is selected.
    /// </summary>
    public bool HasSelection => cef_domdocument_t.has_selection(_self) != 0;

    /// <summary>
    ///     Returns the selection offset within the start node.
    /// </summary>
    public int SelectionStartOffset => cef_domdocument_t.get_selection_start_offset(_self);

    /// <summary>
    ///     Returns the selection offset within the end node.
    /// </summary>
    public int GetSelectionEndOffset => cef_domdocument_t.get_selection_end_offset(_self);
    ...
    public CefDomNode? GetElementById(string id)
    {
        fixed (char* id_str = id)
        {
            ...
            return CefDomNode.FromNativeOrNull(cef_domdocument_t.get_element_by_id(_self, &n_id));
        }
    }
