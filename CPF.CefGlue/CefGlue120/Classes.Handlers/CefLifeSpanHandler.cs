namespace CPF.CefGlue
{
    ...
    public abstract unsafe partial class CefLifeSpanHandler
    {
        ...
        private void on_before_dev_tools_popup(cef_life_span_handler_t* self, cef_browser_t* browser, cef_window_info_t* windowInfo,
            cef_client_t** client, cef_browser_settings_t* settings, cef_dictionary_value_t** extra_info,
            int* use_default_window)
        {
            ...
            var m_settings = new CefBrowserSettings(settings);
            var m_extraInfo = CefDictionaryValue.FromNativeOrNull(*extra_info);
            var m_use_default_window = (*use_default_window) != 0;

            OnBeforeDevToolsPopup(m_browser, m_windowInfo, m_client, m_settings, m_extraInfo, m_use_default_window);
        ...
        /// </summary>
        public virtual void OnBeforeDevToolsPopup(CefBrowser browser, CefWindowInfo windowInfo, CefClient client,
            CefBrowserSettings cefBrowserSettings, CefDictionaryValue extraInfo, bool useDefaultWindow)
        {
        }
