...
{
    private cef_resource_handler_t* create(cef_scheme_handler_factory_t* self, cef_browser_t* browser,
    ...
    /// </summary>
    protected abstract CefResourceHandler? Create(CefBrowser? browser, CefFrame? frame, string? schemeName,
        CefRequest request);
}
