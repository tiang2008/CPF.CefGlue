...
{
    private int on_jsdialog(cef_jsdialog_handler_t* self, cef_browser_t* browser, cef_string_t* origin_url,
        CefJSDialogType dialog_type, cef_string_t* message_text, cef_string_t* default_prompt_text,
        cef_jsdialog_callback_t* callback, int* suppress_message)
    {
        ...
        var result = OnJSDialog(m_browser, m_origin_url, dialog_type, m_message_text, m_default_prompt_text, m_callback,
            out m_suppress_message);
    ...
    /// </summary>
    protected abstract bool OnJSDialog(CefBrowser browser, string? originUrl, CefJSDialogType dialogType,
        string? messageText, string? defaultPromptText, CefJSDialogCallback callback, out bool suppress_message);


    private int on_before_unload_dialog(cef_jsdialog_handler_t* self, cef_browser_t* browser,
    ...
    ///     dialog is dismissed.
    /// </summary>
    protected abstract bool OnBeforeUnloadDialog(CefBrowser browser, string? messageText, bool isReload,
