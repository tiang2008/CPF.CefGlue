...
public abstract unsafe partial class CefUrlRequestClient
{
    ...
    private void on_download_progress(cef_urlrequest_client_t* self, cef_urlrequest_t* request, long current,
        long total)
    {
        CheckSelf(self);
    ...
    private void on_download_data(cef_urlrequest_client_t* self, cef_urlrequest_t* request, void* data,
        UIntPtr data_length)
    {
        CheckSelf(self);
    ...
    private int get_auth_credentials(cef_urlrequest_client_t* self, int isProxy, cef_string_t* host, int port,
        cef_string_t* realm, cef_string_t* scheme, cef_auth_callback_t* callback)
    {
        CheckSelf(self);
    ...
    /// </summary>
    protected virtual bool GetAuthCredentials(bool isProxy, string? host, int port, string? realm, string? scheme,
