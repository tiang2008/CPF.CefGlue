...
public abstract unsafe partial class CefServerHandler
{
    ...
    private void on_http_request(cef_server_handler_t* self, cef_server_t* server, int connection_id,
        cef_string_t* client_address, cef_request_t* request)
    {
        CheckSelf(self);
    ...
    /// </summary>
    protected abstract void OnHttpRequest(CefServer server, int connectionId, string? clientAddress,
        CefRequest request);


    private void on_web_socket_request(cef_server_handler_t* self, cef_server_t* server, int connection_id,
        cef_string_t* client_address, cef_request_t* request, cef_callback_t* callback)
    {
        CheckSelf(self);
    ...
    /// </summary>
    protected abstract void OnWebSocketRequest(CefServer server, int connectionId, string? clientAddress,
        CefRequest request, CefCallback callback);
    ...
    private void on_web_socket_message(cef_server_handler_t* self, cef_server_t* server, int connection_id, void* data,
        UIntPtr data_size)
    {
        CheckSelf(self);
