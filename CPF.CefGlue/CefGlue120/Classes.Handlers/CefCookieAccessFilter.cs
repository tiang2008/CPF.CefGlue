...
{
    private int can_send_cookie(cef_cookie_access_filter_t* self, cef_browser_t* browser, cef_frame_t* frame,
        cef_request_t* request, cef_cookie_t* cookie)
    {
        CheckSelf(self);
    ...
    private int can_save_cookie(cef_cookie_access_filter_t* self, cef_browser_t* browser, cef_frame_t* frame,
        cef_request_t* request, cef_response_t* response, cef_cookie_t* cookie)
    {
        CheckSelf(self);
    ...
    /// </summary>
    protected abstract bool CanSaveCookie(CefBrowser? browser, CefFrame? frame, CefRequest request,
