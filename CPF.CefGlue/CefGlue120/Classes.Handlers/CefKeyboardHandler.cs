...
{
    private int on_pre_key_event(cef_keyboard_handler_t* self, cef_browser_t* browser, cef_key_event_t* @event,
        IntPtr os_event, int* is_keyboard_shortcut)
    {
        CheckSelf(self);
    ...
    /// </summary>
    protected virtual bool OnPreKeyEvent(CefBrowser browser, CefKeyEvent keyEvent, IntPtr os_event,
    ...
    private int on_key_event(cef_keyboard_handler_t* self, cef_browser_t* browser, cef_key_event_t* @event,
        IntPtr os_event)
    {
        CheckSelf(self);
