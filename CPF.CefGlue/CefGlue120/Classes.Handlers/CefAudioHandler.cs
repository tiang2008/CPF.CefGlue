...
public abstract unsafe partial class CefAudioHandler
{
    ...
    private void on_audio_stream_started(cef_audio_handler_t* self, cef_browser_t* browser,
    ...
    private void on_audio_stream_packet(cef_audio_handler_t* self, cef_browser_t* browser, float** data, int frames,
        long pts)
    {
        CheckSelf(self);
