...
public abstract unsafe partial class CefResponseFilter
{
    ...
    private CefResponseFilterStatus filter(cef_response_filter_t* self, void* data_in, UIntPtr data_in_size,
        UIntPtr* data_in_read, void* data_out, UIntPtr data_out_size, UIntPtr* data_out_written)
    {
        CheckSelf(self);
        ...
        {
            if (data_in != null)
                m_in_stream = new UnmanagedMemoryStream((byte*) data_in, (long) data_in_size, (long) data_in_size,
                    FileAccess.Read);
...

            {
                long m_inRead;
                long m_outWritten;
                var result = Filter(m_in_stream, (long) data_in_size, out m_inRead, m_out_stream, (long) data_out_size,
                    out m_outWritten);
    ...
    /// </summary>
    protected abstract CefResponseFilterStatus Filter(UnmanagedMemoryStream? dataIn, long dataInSize,
        out long dataInRead, UnmanagedMemoryStream dataOut, long dataOutSize, out long dataOutWritten);
}