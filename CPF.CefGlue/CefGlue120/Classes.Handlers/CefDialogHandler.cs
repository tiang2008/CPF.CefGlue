...
{
    private int on_file_dialog(
        cef_dialog_handler_t* self,
        cef_browser_t* browser,
        CefFileDialogMode mode,
        cef_string_t* title,
        cef_string_t* default_file_path,
        cef_string_list* accept_filters,
        cef_string_list* accept_extensions,
        cef_string_list* accept_descriptions,
    ...
    ///     dialog return false.
    /// </summary>
    protected virtual bool OnFileDialog(CefBrowser browser, CefFileDialogMode mode, string? title,
        string? defaultFilePath, string[] acceptFilters, string[] acceptExtensions, string[] acceptDescriptions, CefFileDialogCallback callback)
    {
        return false;
    }
}