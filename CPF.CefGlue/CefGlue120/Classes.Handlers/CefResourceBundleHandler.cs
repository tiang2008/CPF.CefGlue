...
public abstract unsafe partial class CefResourceBundleHandler
{
    ...
    private int get_data_resource_for_scale(cef_resource_bundle_handler_t* self, int resource_id,
    ...
    /// </summary>
    protected virtual bool GetDataResourceForScale(int resourceId, CefScaleFactor scaleFactor, out void* data,
