...
{
    private void on_media_route_create_finished(cef_media_route_create_callback_t* self,
    ...
    /// </summary>
    protected abstract void OnMediaRouteCreateFinished(CefMediaRouteCreateResult result, string? error,
        CefMediaRoute? route);
}
