...
{
    private void on_request_context_initialized(cef_request_context_handler_t* self,
    ...
    private cef_resource_request_handler_t* get_resource_request_handler(cef_request_context_handler_t* self,
        ...
        cef_string_t* request_initiator, int* disable_default_handling)
    {
        ...
        var m_result = GetResourceRequestHandler(m_browser, m_frame, m_request, m_isNavigation, m_isDownload,
            m_requestInitiator, ref m_disableDefaultHandling);
