namespace CPF.CefGlue.Wrapper
{
    ...
    using BrowserRequestInfoMap = CefBrowserInfoMap<System.Collections.Generic.KeyValuePair<int, int>, CPF.CefGlue.Wrapper.CefMessageRouterRendererSide.RequestInfo>;
