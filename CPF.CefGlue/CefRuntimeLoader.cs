...
namespace CPF.CefGlue
{
    public static class CefRuntimeLoader
    {
        ...
        private static Action<CefBrowserProcessHandler> _delayedInitialization;
        ...
        private static void InternalInitialize(CefSettings settings = null, KeyValuePair<string, string>[] flags = null, CustomScheme[] customSchemes = null, CefBrowserProcessHandler browserProcessHandler = null)
        {
            CefRuntime.Load();
        ...
        internal static void Load(CefBrowserProcessHandler browserProcessHandler = null)
        {
