...
namespace CPF.CefGlue.JSExtenstions
{
    internal static class CefValueSerialization
    {
        ...
        //    Converters =
        //    {
        //        new JsonConverters.StringJsonConverter(),
        //        new JsonConverters.DateTimeJsonConverter(),
        //        new JsonConverters.BinaryJsonConverter()
        //    },
        //    IncludeFields = true,
        ...
        //    Converters =
        //    {
        //        new JsonConverters.ObjectJsonConverter()
        //    },
        ...
        private static object DeserializeAsJson(string value)
        {
            try
            {
                return JsonSerializer.ToObject<object>(value);
            }
            catch (Exception e)
            {
                // wrap the json exception
        ...
        public static TListElementType[] DeserializeCefList<TListElementType>(CefListValue cefList)
        {
