...
namespace CPF.CefGlue.JSExtenstions
{
    internal class NativeMethod
    {
        ...
        {
            if (_mandatoryParameters != null && args.Length < _mandatoryParameters.Length)
            {
        ...
        private static bool IsParamArray(ParameterInfo paramInfo)
        {
            ...
            var ass = paramInfo.GetCustomAttributes(typeof(ParamArrayAttribute), false);
            return ass != null && ass.Length > 0;
        }
    }
}
