...
namespace CPF.CefGlue.JSExtenstions
{
    ...
    {
        #region CefGlueGlobal
        private const string GlobalObjectName = "cpfcefglue";
        ...
        public static readonly string CefGlueGlobal =
        ...
        {
            // TODO global name
            CefRuntime.RegisterExtension("cpfcefExtensionName", CefGlueGlobal, new V8BuiltinFunctionHandler(nativeObjectRegistry));
        }
